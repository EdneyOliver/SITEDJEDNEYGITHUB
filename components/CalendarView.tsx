...
export const CalendarView: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="glass rounded-3xl p-6 sm:p-8 md:p-12 neon-border relative overflow-hidden group">
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-purple-600 to-blue-600 rounded-2xl flex items-center justify-center mb-6 sm:mb-8 shadow-[0_0_30px_rgba(147,51,234,0.3)] group-hover:scale-110 transition-transform duration-500">
            <i className="fas fa-calendar-check text-2xl sm:text-3xl text-white"></i>
          </div>
          
          <h3 className="text-xl sm:text-2xl md:text-4xl font-sync font-black text-white uppercase tracking-tight mb-4 sm:mb-6 leading-tight">
            Sua data ainda está <span className="text-purple-500">disponível?</span>
          </h3>
          
          <p className="text-gray-400 text-xs sm:text-sm md:text-base max-w-2xl mx-auto mb-8 sm:mb-10 leading-relaxed uppercase tracking-wider font-medium">
          ...
          <a 
            ...
            className="group/btn relative inline-flex items-center justify-center gap-3 sm:gap-4 px-6 sm:px-10 py-4 sm:py-5 bg-green-600 hover:bg-green-500 text-white rounded-full transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(22,163,74,0.4)] max-w-full"
          >
            <i className="fab fa-whatsapp text-xl sm:text-2xl animate-bounce shrink-0"></i>
            <span className="font-sync font-black text-[10px] sm:text-xs md:text-sm uppercase tracking-wider sm:tracking-widest text-center">
